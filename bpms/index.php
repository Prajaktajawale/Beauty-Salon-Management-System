...
<html lang="en">
  <head>
    ...
    <title>Beauty salon Management System | Home Page</title>
  ...
  <div class="css-slider">
    ...
    <section class="slide slide-one">
      <div class="container">
        <div class="banner-text">
          <h4>Be Sassy Here</h4>
          <h3>Beauty Comes From Inside ,<br>
            Inside The Beauty Salon</h3>
    ...
    <section class="slide slide-two">
      <div class="container">
        <div class="banner-text">
          <h4>Be Sassy Here</h4>
          <h3> If it makes u feel beautiful ,<br>
           then do it !</h3>
          <a href="book-appointment.php" class="btn logo-button top-margin">Get An Appointment</a>
        </div>
      </div>
            ...
            <div class="grids">
                    <div class="grids-content row">
                        ...
                        <div class="column col-lg-4 col-md-6 color-2 ">
                            ...
                            <p class="para ">Sassy Hair and Beauty Salon Offers - Beauty Services</p>
                            <a href="about.php" class="action-button btn mt-md-4 mt-3">Read more</a>
                        </div>
                    </div>
                        <div class="column col-lg-4 col-md-6 col-sm-6 back-image  ">
                            <img src="assets/foto/p4.png" alt="product" class="img-responsive ">
                        </div>
                        <!---<div class="column col-lg-4 col-md-7 col-sm-7 back-image2 ">
                            <img src="assets/foto/p3 (2).jpg" alt="product" class="img-responsive ">
                          </div> -->
                    </div>
                </div>
        </div>
        ...
        <div class="container">
            <div class=" row">
                <div class="col-lg-6 back-image">
                    <img src="assets/foto/interior (1).jpg" alt="product" class="img-responsive ">
                </div>
